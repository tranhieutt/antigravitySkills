---
name: cmd-rust-review
description: "Comprehensive Rust code review for ownership, lifetimes, error handling, unsafe usage, and idiomatic patterns. Invokes t..."
...
> **ECC Command** — Gọi bằng \@cmd-rust-review\ trong Antigravity, hoặc \/rust-review\ trong Claude Code.
...
1. **Verify Automated Checks**: Run `cargo check`, `cargo clippy -- -D warnings`, `cargo fmt --check`, and `cargo test` â€” stop if any fail
