...
> **ECC Command** — Gọi bằng \@cmd-cpp-test\ trong Antigravity, hoặc \/cpp-test\ trong Claude Code.
...
```
RED     â†’ Write failing GoogleTest test
GREEN   â†’ Implement minimal code to pass
REFACTOR â†’ Improve code, tests stay green
REPEAT  â†’ Next test case
```
...
âœ“ Tests fail as expected (unimplemented).
