...
> **ECC Command** — Gọi bằng \@cmd-instinct-status\ trong Antigravity, hoặc \/instinct-status\ trong Claude Code.
...
## PROJECT-SCOPED (my-app)
  ### WORKFLOW (3)
    â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–‘â–‘â–‘  70%  grep-before-edit [project]
              trigger: when modifying code

## GLOBAL (apply to all projects)
  ### SECURITY (2)
    â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–‘  85%  validate-user-input [global]
