...
> **ECC Command** — Gọi bằng \@cmd-gradle-build\ trong Antigravity, hoặc \/gradle-build\ trong Claude Code.
...
1. **Read the file** â€” Full context around the error line
2. **Diagnose** â€” Common categories:
...
3. **Fix minimally** â€” Smallest change that resolves the error
4. **Re-run build** â€” Verify fix and check for new errors
5. **Continue** â€” Move to next error
