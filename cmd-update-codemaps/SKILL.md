---
name: cmd-update-codemaps
description: "ECC slash command: /update-codemaps"
...
> **ECC Command** — Gọi bằng \@cmd-update-codemaps\ trong Antigravity, hoặc \/update-codemaps\ trong Claude Code.
...
| `backend.md` | API routes, middleware chain, service â†’ repository mapping |
...
Each codemap should be token-lean â€” optimized for AI context consumption:

```markdown
# Backend Architecture

## Routes
POST /api/users â†’ UserController.create â†’ UserService.create â†’ UserRepo.insert
GET  /api/users/:id â†’ UserController.get â†’ UserService.findById â†’ UserRepo.findById
