...
> **ECC Command** — Gọi bằng \@cmd-tdd\ trong Antigravity, hoặc \/tdd\ trong Claude Code.
...
FAIL lib/liquidity.test.ts
  âœ• should return high score for liquid market (2 ms)
...
- âœ… Add edge cases and error scenarios
...
- âŒ Mock everything (prefer integration tests)
