---
name: cmd-context-budget
description: "Analyze context window usage across agents, skills, MCP servers, and rules to find optimization opportunities. Helps red..."
...
> **ECC Command** — Gọi bằng \@cmd-context-budget\ trong Antigravity, hoặc \/context-budget\ trong Claude Code.
...
3. Follow the skill's four phases: Inventory â†’ Classify â†’ Detect Issues â†’ Report
