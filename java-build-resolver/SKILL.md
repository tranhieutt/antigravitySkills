...
- Working on java-build-resolver tasks or workflows
- Needing guidance, best practices, or checklists for java-build-resolver

## Do not use this skill when

- The task is unrelated to java-build-resolver
