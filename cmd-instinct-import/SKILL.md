...
> **ECC Command** — Gọi bằng \@cmd-instinct-import\ trong Antigravity, hoặc \/instinct-import\ trong Claude Code.
...
```
ðŸ“¥ Importing instincts from: team-instincts.yaml
================================================
