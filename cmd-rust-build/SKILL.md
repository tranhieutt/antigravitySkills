---
name: cmd-rust-build
description: "Fix Rust build errors, borrow checker issues, and dependency problems incrementally. Invokes the rust-build-resolver age..."
...
> **ECC Command** — Gọi bằng \@cmd-rust-build\ trong Antigravity, hoặc \/rust-build\ trong Claude Code.
...
Error: E0502 â€” cannot borrow `map` as mutable because also borrowed as immutable
...
Error: E0308 â€” mismatched types: expected `usize`, found `&str`
...
Error: E0425 â€” cannot find value `db` in this scope
