...
- **Tổng số thư mục kỹ năng**: 1,557 (Đã cập nhật bộ Anthropic, Sec, Game Dev, The Agency, Khoa học, Awesome Skills bổ sung & Garry Tan CEO Skills)
...
- **Management & Workflows**: Bổ sung bộ `@garrytan_ceo_skills` phân tích quản trị, code review và shipping.
...
- **[2026-03-16] Thêm Garry Tan CEO Skills**: Bổ sung bộ kỹ năng `garrytan_ceo_skills` bao gồm các workflow kỹ thuật, audit và quản lý dự án (từ Garry Tan's GStack). Tổng số bộ kỹ năng là 1,557.
