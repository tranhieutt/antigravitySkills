...
> **ECC Command** — Gọi bằng \@cmd-skill-health\ trong Antigravity, hoặc \/skill-health\ trong Claude Code.
...
- **Success Rate (30d)** â€” Sparkline charts showing daily success rates per skill
- **Failure Patterns** â€” Clustered failure reasons with horizontal bar chart
- **Pending Amendments** â€” Amendment proposals awaiting review
- **Version History** â€” Timeline of version snapshots per skill
