---
name: cmd-pm2
description: "ECC slash command: /pm2"
...
> **ECC Command** — Gọi bằng \@cmd-pm2\ trong Antigravity, hoặc \/pm2\ trong Claude Code.
...
â”œâ”€â”€ {backend}/start.cjs               # Python wrapper (if applicable)
â””â”€â”€ .claude/
    â”œâ”€â”€ commands/
    â”‚   â”œâ”€â”€ pm2-all.md                # Start all + monit
    â”‚   â”œâ”€â”€ pm2-all-stop.md           # Stop all
    â”‚   â”œâ”€â”€ pm2-all-restart.md        # Restart all
    â”‚   â”œâ”€â”€ pm2-{port}.md             # Start single + logs
    â”‚   â”œâ”€â”€ pm2-{port}-stop.md        # Stop single
    â”‚   â”œâ”€â”€ pm2-{port}-restart.md     # Restart single
    â”‚   â”œâ”€â”€ pm2-logs.md               # View all logs
    â”‚   â””â”€â”€ pm2-status.md             # View status
    â””â”€â”€ scripts/
        â”œâ”€â”€ pm2-logs-{port}.ps1       # Single service logs
        â””â”€â”€ pm2-monit.ps1             # PM2 monitor
```
