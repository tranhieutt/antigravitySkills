---
name: cmd-devfleet
description: "Orchestrate parallel Claude Code agents via Claude DevFleet â€” plan projects from natural language, dispatch agents in ..."
...
> **ECC Command** — Gọi bằng \@cmd-devfleet\ trong Antigravity, hoặc \/devfleet\ trong Claude Code.

---
description: Orchestrate parallel Claude Code agents via Claude DevFleet â€” plan projects from natural language, dispatch agents in isolated worktrees, monitor progress, and read structured reports.
---

# DevFleet â€” Multi-Agent Orchestration
...
User describes project
  â†’ plan_project(prompt) â†’ mission DAG with dependencies
  â†’ Show plan, get approval
  â†’ dispatch_mission(M1) â†’ Agent spawns in worktree
  â†’ M1 completes â†’ auto-merge â†’ M2 auto-dispatches (depends_on M1)
  â†’ M2 completes â†’ auto-merge
  â†’ get_report(M2) â†’ files_changed, what_done, errors, next_steps
...
4. **Monitor progress** â€” check what's running:
...
- Dependencies form a DAG â€” never create circular dependencies
