...
> **ECC Command** — Gọi bằng \@cmd-rust-test\ trong Antigravity, hoặc \/rust-test\ trong Claude Code.
...
## Step 3: Run Tests â€” Verify FAIL
...
## Step 5: Run Tests â€” Verify PASS
...
- Use `sleep()` in tests â€” use channels or `tokio::time::pause()`
