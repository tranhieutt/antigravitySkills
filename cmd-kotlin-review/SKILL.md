---
name: cmd-kotlin-review
description: "Comprehensive Kotlin code review for idiomatic patterns, null safety, coroutine safety, and security. Invokes the kotlin..."
...
> **ECC Command** — Gọi bằng \@cmd-kotlin-review\ trong Antigravity, hoặc \/kotlin-review\ trong Claude Code.
...
âœ“ Build: Successful
âœ“ detekt: No issues
âš  ktlint: 2 formatting warnings
...
Recommendation: âŒ Block merge until CRITICAL issue is fixed
````
...
| âš ï¸ Warning | Only MEDIUM issues (merge with caution) |
| âŒ Block | CRITICAL or HIGH issues found |
