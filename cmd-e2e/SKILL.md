...
> **ECC Command** — Gọi bằng \@cmd-e2e\ trong Antigravity, hoặc \/e2e\ trong Claude Code.
...
Artifacts:
ðŸ“¸ Screenshots: 2 files
ðŸ“¹ Videos: 0 files (only on failure)
ðŸ” Traces: 0 files (only on failure)
...
**DON'T:**
- âŒ Use brittle selectors (CSS classes can change)
- âŒ Test implementation details
- âŒ Run tests against production
- âŒ Ignore flaky tests
- âŒ Skip artifact review on failures
- âŒ Test every edge case with E2E (use unit tests)
