...
- Working on rust-build-resolver tasks or workflows
- Needing guidance, best practices, or checklists for rust-build-resolver

## Do not use this skill when

- The task is unrelated to rust-build-resolver
